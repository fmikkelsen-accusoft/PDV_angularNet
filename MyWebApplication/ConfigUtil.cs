...
namespace MyWebApplication
{
    ...
    public static class ConfigUtil
    {
        ...
        public static async Task ValidatePasConnectionAsync(IConfiguration configuration)
        {
            ...
            // Create a one-off HTTP client we'll use just to test the configuration.
            var pasHttpClient = new HttpClient();

            PasUtil.ConfigureHttpClientForPas(pasHttpClient, configuration);
